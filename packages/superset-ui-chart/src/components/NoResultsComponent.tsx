...
const BODY_STRING =
    t('No results were returned for this query. If you expected results to be returned, ensure any filters are configured properly and the datasource contains data for the selected time range.');
const TITLE_STRING = t('No Results')
  ...
  return (
    ...
    >
      <div style={MESSAGE_STYLES}>
        <div style={TITLE_STYLES}>{TITLE_STRING}</div>
